//This Program is to take a large piece of JSON data and find different values for that data.
//Pretty Print JSON
...
poke.height;
poke.held_items[0].item.url;
poke.sprites;
poke.stats[0].stat.name;
poke.types[0].slot;
poke.weight;
poke.moves[0].version_group_details;
