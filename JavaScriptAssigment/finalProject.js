...
function baseRandomNumber(min, max) {
...
function randomNumber1() {
    var a= baseRandomNumber(1, 100)
    document.getElementById("p1").innerHTML = a;
}

//random number between "Start" and "End"
function randomNumber2() {
    var start = document.getElementById("rand1").value
    var end = document.getElementById("rand2").value
    var a = baseRandomNumber(start, end)
...
function date()
{
    ...
    var date= currentDate+ "\nAnd the normal date is : " + currentDate.getDate() + "-" + (currentDate.getMonth() + +1)+ "-" + currentDate.getFullYear()
    document.getElementById("p6").innerHTML = date;
...
function randomPassword() {
    ...
    document.getElementById("p11").innerHTML = a + "--> Size of password is:" + a.length
}
